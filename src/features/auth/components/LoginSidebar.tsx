...
export function LoginSidebar() {
  return (
    <div className="hidden lg:flex flex-col relative w-1/2 bg-[#020817] p-8 text-white overflow-hidden">
      ...
      >
        ...
        <div>
          <h1 className="text-lg font-bold tracking-tight">EduManager CI</h1>
          <p className="text-[10px] text-slate-400">Système de Gestion Scolaire</p>
        </div>
      </motion.div>
      ...
      <div className="mt-auto relative z-10">
        ...
        <motion.p 
          ...
          className="mt-4 text-slate-400 text-base max-w-sm leading-relaxed"
        >
