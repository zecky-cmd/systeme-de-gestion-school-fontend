...
export function DeleteConfirmModal({
  ...
  description = "Cette action est irréversible et supprimera définitivement cet élément.",
      ...
      <DialogContent className="max-w-md bg-white rounded-2xl border-none shadow-2xl p-0 overflow-hidden">
        ...
        <div className="p-6">
          <p className="text-sm text-slate-600 leading-relaxed">
            ...
            <span className="font-semibold text-slate-900">"{itemName}"</span> ? {description}
          </p>
        </div>
