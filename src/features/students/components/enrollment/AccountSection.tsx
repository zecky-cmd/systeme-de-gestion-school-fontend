...
export function AccountSection({ readonlyEmail, readonlyPassword }: AccountSectionProps) {
  ...
  return (
    <div className="space-y-4 pt-4">
      ...
      <div className="space-y-2">
        ...
        <Input id="email" type="email" {...register("email")} placeholder="jean.k@email.com" disabled={readonlyEmail} />
        {errors.email && <p className="text-[10px] text-red-500">{errors.email.message}</p>}
      </div>
      <div className="space-y-2">
        <Label htmlFor="password">Mot de passe provisoire</Label>
        <Input id="password" type="text" {...register("password")} disabled={readonlyPassword} />
